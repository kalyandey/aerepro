                                ...
                                <div class="col-md-12">
                                    ...
                                    <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">{!! Form::text('zip',(count($lists->permit_owner)>0)?$lists->permit_owner->zip:'',['class'=>'form-control','id' => 'Zip'])!!}</div>
                                        </div>
                                        <div class="form-group">
                                            <label for="phone" class="col-md-3 control-label">Owner Phone</label>
                                            <div class="col-md-9">{!! Form::text('phone',(count($lists->permit_owner)>0)?$lists->permit_owner->phone:'',['class'=>'form-control','id' => 'phone'])!!}</div>
                                        </div>    
