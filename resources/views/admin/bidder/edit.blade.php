...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <a href="{{ URL::route('admin_bidder_database_list') }}">Bidder Database</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
...
<div class="page-content">
		    ...
		    <div class="panel panel-yellow">
                            <div class="panel-heading">Bidder Update</div>
                            <div class="panel-body pan">                                    
                                    {!! Form::open(array('route'=>array('admin_bidder_database_update',$lists->id),'class'=>'form-horizontal form-validate')) !!}
					...
					<div class="form-group"><label class="col-md-3 control-label" for="inputName">Status</label>
                                    ...
                                    <div class="form-actions pal">
                                        <div class="form-group mbn">
                                            ...
                                            {!! Html::linkRoute('admin_bidder_database_list', 'Cancel', array(), array('class' => 'btn btn-green')) !!}
                                            </div>
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
