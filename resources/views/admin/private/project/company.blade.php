                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="topTabText">
                                    <div class="col-md-3 btn btn-primary" style="border-right:1px solid #FFF">1. Company</div>
                                    <div class="col-md-3 btn btn-default" style="border-right:1px solid #FFF">2. Details </div>
                                    <div class="col-md-3 btn btn-default" style="border-right:1px solid #FFF">3. Plans </div>
                                    <div class="col-md-3 btn btn-default" style="border-right:1px solid #FFF">4. Specs </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br>
                                        {!! Form::open(array('route'=>array('admin_private_company'),'class'=>'form-validate form-horizontal','files'=>true,'method'=>'post')) !!}
                                        {!! Form::hidden('action','Process')!!}
                                        <div class="form-group">
                                            <label for="Company Name" class="col-md-3 control-label">Select Company</label>
                                            <div class="col-md-9">{!! Form::select('company',$companies,'',['class'=>'form-control required','id' => 'company'])!!}</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">{!! Form::password('password',['class'=>'form-control required','id' => 'password'])!!}</div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">{!! Form::file('logo',['class'=>'form-control','id' => 'logo'])!!}</div>
                                        </div>
                                        </div>        
