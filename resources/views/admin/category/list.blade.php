...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <a href="javascript:void(0);">Category</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
                            ...
                            <div class="portlet-body">
								...
								<tr>
									...
									<td>
											...
											<li><a href="{{ URL::route('admin_category_edit',$r->id) }}">Edit</a></li>
                                                                                        <li><a href="{{ URL::route('admin_category_delete',$r->id) }}">Delete</a></li>
