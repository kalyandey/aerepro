...
@section('content')
    <div class="page-title-breadcrumb" id="title-breadcrumb-option-demo">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <a href="{{ URL::route('admin_permittype') }}">Permit Type</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;
                    </li>
                    <li>
...
<div class="page-content">
		    ...
		    <div class="panel panel-yellow">
                            <div class="panel-heading">Permit Type Update</div>
                            <div class="panel-body pan">                                    
                                    {!! Form::open(array('route'=>array('admin_permittype_update',$lists->id),'class'=>'form-horizontal form-validate')) !!}
