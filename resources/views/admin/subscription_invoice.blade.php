 ...
 <tr><td border="0" colspan="2" style="line-height:10px; height:10px;background-color:#10367f; border-top:2px solid #10367f; border-bottom:2px solid #10367f;">&nbsp;</td></tr>
    <tr>
            ...
            <tr><td border="0"  style="line-height:30px; height:30px;">&nbsp;</td></tr>
             ...
             <tr><td border="0"  style="line-height:30px; height:30px;">&nbsp;</td></tr>   
                <tr>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">{!! $sub->user->first_name.' '.$sub->user->last_name !!}</td>
                ...
                <tr>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">{!! $sub->user->business_name !!}</td>
		...
		<tr>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">{!! $sub->user->email !!}</td>
                ...
                <tr>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">
                        {!! ($sub->user->addess_line1 != '')?$sub->user->addess_line1.',<br>':'' !!}
                        {!! ($sub->user->addess_line2 != '')?$sub->user->addess_line2.',<br>':'' !!}
                        {!! ($sub->user->city != '')?$sub->user->city:'' !!}
                        {!! (($sub->user->city != '') && (count($sub->user->state_name)>0))?',':'' !!}
                        {!! (($sub->user->state != '') && (count($sub->user->state_name)>0))?$sub->user->state_name->state:'' !!}
                        {!! (($sub->user->zip != '') && (count($sub->user->state_name)>0))?',':'' !!}
                        {!! ($sub->user->zip != '')?','.$sub->user->zip:'' !!}
                    </td>
                ...
                <tr>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">{!! date('Y-m-d',strtotime($sub->created_at)) !!}</td>
				...
				@php $pay = $sub @endphp
                                <tr>
                                    ...
                                    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px;text-align:left; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;">
                                        ...
                                        @endphp
                                        {{date('Y-m-d',strtotime($exp->end_date))}}
                                    </td>
                                ...
                                <tr>                           
                                    ...
                                    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px;text-align:left; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;" colspan="2">${!! $totalAmount !!}</td>
				</tr>
                        </tbody>
		</table>
            </td>
