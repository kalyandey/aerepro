...
<div class="page-content">
		    ...
		    <div class="panel panel-yellow">
                            <div class="panel-heading">County Add</div>
                            <div class="panel-body pan">                                    
                                    {!! Form::open(array('route'=>'admin_county_add','class'=>'form-horizontal form-validate')) !!}
                                    <div class="form-body pal">
                                        ...
                                        <div class="form-group"><label class="col-md-3 control-label" for="inputName">County</label>
                                            <div class="col-md-9">
                                                <div class="input-icon right">
                                                            {!! Form::text('county_name',null,array('class'=>'form-control required','placeholder'=>'Enter County Name','id'=>'county_name' ))!!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions pal">
                                        <div class="form-group mbn">
                                            ...
                                            {!! Html::linkRoute('admin_county', 'Back', array(), array('class' => 'btn btn-default')) !!}
                                            </div>
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
