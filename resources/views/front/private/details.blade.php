      <div class="popup_sec">
         <div class="popup_inner popup_inner1 private-planroom-details">
            <div class="popIn">
            ...
            <div id="horizontalTab">
               ...
               <div class="resp-tabs-container">
                  ...
                  <form class="table_chkbox2">
                     <table id="no-more-tables" class="res-table2 tbl1 job_table">
                        <thead>
                           <tr>
                           ...
                           @if(count($details->plan)>0)
                              ...
                              <tr {{(($k%2) == 0)?"class='l-clck'":''}} >
                                 ...
                                 <td data-title="County">
                                    <div class="{!! $plan->plan_category->name !!} divison_details">{!! $plan->plan_category->name !!}</div>
                                    @if(Helpers::isFileExist('uploads/private_planroom/plan/'.$plan->file_name) && $plan->file_name != '')
