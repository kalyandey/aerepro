...
<tr><td border="0" colspan="6" align="center" style="background-color:#10367f; border-top:2px solid #10367f; border-bottom:2px solid #10367f;"><img src="http://aerepro.dedicatedresource.net/images/logo.png" style="width:230px; border:0;"></td></tr>
 <tr><td border="0" colspan="6" style="line-height:10px; height:10px;background-color:#10367f; border-top:2px solid #10367f; border-bottom:2px solid #10367f;">&nbsp;</td></tr>
    <tr>
        <td border="0" style="background-color:#fff; width:70%;" colspan="4">
            ...
            <tr><td border="0"  style="line-height:10px; height:10px;">&nbsp;</td></tr>
                ...
                <td border="0" style="width:5px"></td>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">#ORD10018</td>
                        <td border="0" style="width:5px"></td>
                </tr>
                <tr><td border="0" style="line-height:10px; height:10px;">&nbsp;</td></tr>
                <tr>
                <td border="0" style="width:5px"></td>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">N/A</td>
                        <td border="0" style="width:5px"></td>
                </tr>
                <tr><td border="0" style="line-height:10px; height:10px;">&nbsp;</td></tr>
                <tr>
                <td border="0" style="width:5px"></td>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">Local Delivery</td>
                        <td border="0" style="width:5px"></td>
                </tr>
                <tr><td border="0" style="line-height:10px; height:10px;">&nbsp;</td></tr>
                <tr>
                <td border="0" style="width:5px"></td>
                    ...
                    <td border="0" style="font-family:arial, sans-serif; font-size:14px; line-height:14px; height:14px;">1788 ghgfh, Arizona, 86305,</td>
                        <td border="0" style="width:5px"></td>
                </tr>
                <tr><td border="0" style="line-height:10px; height:10px;">&nbsp;</td></tr>
            </table>
        ...
        <td border="0" style="background-color:#fff; width:10%;" >
             <table border="0" cellspacing="0" cellpadding="0"  style="background-color:#fff; letter-spacing: 0.5px;">
                ...
                <tr>
                <td border="0" style="width:5px"></td>
                    <td border="0" style="font-family:arial, sans-serif; font-size:13px; line-height:13px; height:13px;">Tonmoy Nandy</td>
                <td style="width:5px"></td>
                </tr>
                  <tr><td    style="line-height:5px; height:5px;">&nbsp;</td></tr>
                    <tr>
                <td style="width:5px"></td>
                    <td style="font-family:arial, sans-serif; font-size:13px; line-height:13px; height:13px;">1788 ,55225</td>
                <td style="width:5px"></td>
                </tr>
					<tr><td    style="line-height:3px; height:3px;">&nbsp;</td></tr>
					<tr>
                <td style="width:5px"></td>
                    <td style="font-family:arial, sans-serif; font-size:13px; line-height:13px; height:13px;">ghgfh, Minnesota, 86305,</td>
                <td style="width:5px"></td>
                </tr>
                    <tr><td style="line-height:12px; height:12px;">&nbsp;</td></tr>
                <tr>
                <td style="width:5px"></td>
                    <td style="font-family:arial, sans-serif; font-size:13px; line-height:13px; height:13px; color:#cf0f31;">(546) 696-5656</td>
                <td style="width:5px"></td>
                </tr>
                    <tr><td    style="line-height:5px; height:5px;">&nbsp;</td></tr>
                        <tr>
                <td style="width:5px"></td>
                    <td style="font-family:arial, sans-serif; font-size:13px; line-height:13px; height:13px;">tonmoy.nandy@webskitters.com </td>
                <td style="width:5px"></td>
                </tr>
        ...
        <tr>
            <td style="background-color:#f5f5f5; width:100%;" colspan="6">
                        ...
                        <tbody style="background:#fff;">
						    ...
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px; text-align:center; background-color:#eee; border-right:1px solid #ccc; border-bottom:1px solid #ccc; border-left:1px solid #ccc; padding:6px 8px;">10785</td>
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px;text-align:left; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;"> 01 08 E1 Electrical Notes & Symbols</td>
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px; text-align:center; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;">Full Size</td>
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px; text-align:left; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;">Local Delivery<br><b>Address :</b> 1788<br><b>City :</b> Ghgfh<br><b>States :</b> 3<br><b>Zip :</b> 86305</td>
                                <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px; text-align:center; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;">1</td>
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px; text-align:center; background-color:#eee;border-right:1px solid #ccc; border-bottom:1px solid #ccc; padding:6px 8px;">$ 1.17</td>
...
<tr>
            ...
            <tr>
                ...
                <td style="width:5px; background:#000;"></td>
                    ...
                    <td style="font-family:arial, sans-serif; font-size:14px;background:#333; padding: 8px; line-height:14px; height:14px; text-align:left; color:#fff; border-bottom:1px solid #fff;">2.00</td>
                        <td style="width:5px"></td>
                </tr>
                
                <tr>
                <td style="width:5px;background:#000;"></td>
                    <td style="font-family:arial, sans-serif; font-size:14px;  background:#000; padding: 8px; line-height:14px; height:14px; text-align:left; color:#fff; border-bottom:1px solid #fff;"><b>Tax</b></td>
                    <td style="font-family:arial, sans-serif; font-size:14px;background:#333; padding: 8px; line-height:14px; height:14px; text-align:left; color:#fff; border-bottom:1px solid #fff;">0.17</td>
                        <td style="width:5px"></td>
                </tr>
                ...
                <td style="width:5px;background:#000;"></td>
                    ...
                    <td style="font-family:arial, sans-serif; font-size:14px;background:#333; padding: 8px; line-height:14px; height:14px; text-align:left; color:#fff; border-bottom:1px solid #fff;">2.17</td>
                        <td style="width:5px"></td>
                </tr>
                ...
                <td style="width:5px;background:#000;"></td>
                    ...
                    <td style="font-family:arial, sans-serif; font-size:14px;background:#333; padding: 8px; line-height:14px; height:14px; text-align:left; color:#fff; border-bottom:1px solid #fff;">My Account</td>
                        <td style="width:5px"></td>
                </tr>
