        ...
        <tr>
            <td style="background-color:#f5f5f5; width:100%;" colspan="4">
				...
				@php $i++ @endphp
						    ...
						    <td style="font-family:arial, sans-serif; font-size:14px; line-height:15px; height:15px;text-align:center; background-color:#eee;">
            ...
            <tr>
                <td style="line-height:30px;background-color:#fff; height:30px;" colspan="5"></td>
                 ...
                 <tr>
                 <td colspan="2" valign="bottom">@if($details->note !='')
