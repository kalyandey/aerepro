...
Route::any('test-pdf',                          array('as' => 'pdf_test',               'uses'=>'TestController@pdf_test' ));
Route::any('view_pdf',                          array('as' => 'view_pdf',               'uses'=>'TestController@view_pdf' ));
Route::any('emailtemplate',                     array('as' => 'emailtemplate',          'uses'=>'TestController@emailtemplate' ));
Route::any('pdf_test_subscribe',                array('as' => 'pdf_test_subscribe',     'uses'=>'TestController@pdf_test_subscribe' ));
Route::any('order_invoice_html',                array('as' => 'order_invoice',          'uses'=>'TestController@order_invoice' ));
Route::any('/test',                             array('as' => 'test',                   'uses'=>'TestController@index' ));
Route::any('/testing',                          array('as' => 'testing',                'uses'=>'TestController@testing' ));
...
Route::group(array('middleware' => 'user'), function (){
    ...
    Route::any('/disable-subscription/{id}',    array('as' => 'disableSubscription',        'uses'=>'UserController@disableSubscription' ));
    Route::any('/enable-subscription/{id}',     array('as' => 'enableSubscription',         'uses'=>'UserController@enableSubscription' ));
    ...
    Route::any('/add-card-info',                array('as' => 'add_card_info',              'uses'=>'UserController@add_card_info' ));
    Route::any('/delete_card_info',             array('as' => 'delete_card_info',           'uses'=>'UserController@delete_card_info' ));
    ...
    Route::any('/order-invoice/{id}',           array('as' => 'print_order',               'uses'=>'OrderController@print_order' ));
    Route::any('/download-zip/{id}/{project_id}',array('as' => 'download_zip',              'uses'=>'OrderController@download_zip' ));
    Route::any('/calendar',                     array('as' => 'calendar',                  'uses'=>'UserController@getcalendar' ));
    Route::any('/subscription-details-pdf/{id}',array('as' => 'subscription-details-pdf',  'uses'=>'UserController@subscription_details_pdf' ));
    
    Route::any('/customer-files',               array('as' => 'customer_files',            'uses'=>'CustomerFileUploadController@index' ));
    Route::any('/user/customer-upload-pdf',     array('as' => 'customer_upload_pdf',       'uses'=>'CustomerFileUploadController@upload_pdf' ));
    Route::any('/user/file-lists',              array('as' => 'file_lists',                'uses'=>'CustomerFileUploadController@file_lists' ));
    Route::any('/delete-multiple-files',        array('as' => 'delete_multiple_files',     'uses'=>'CustomerFileUploadController@delete_multiple_files' ));
    Route::any('/user/file-delete',             array('as' => 'file_delete_individual',    'uses'=>'CustomerFileUploadController@file_delete' ));
    Route::any('/user/zip_file_create',         array('as' => 'customer_zip_file',         'uses'=>'CustomerFileUploadController@zip_file_create' ));
...
Route::group(array('prefix'=>'admin','namespace' => 'admin','middleware' => 'admin'), function (){
     ...
     Route::any('/subscriptions-payment/{user_id}/{id}',   array('as' => 'front_user_subscribe_single', 'uses'=>'UserController@subscribe_single' ));
     Route::any('/front-user-payment/{id}',      array('as' => 'front_user_payment',       'uses'=>'UserController@front_user_payment' ));
     Route::any('/customer-files/{id}',          array('as' => 'front_project_plans',      'uses'=>'CustomerFileUploadController@index' ));
     Route::any('/customer-upload-pdf',          array('as' => 'customer_upload_pdf',      'uses'=>'CustomerFileUploadController@upload_pdf' ));
     Route::any('/file-lists',                   array('as' => 'admin_file_lists',         'uses'=>'CustomerFileUploadController@file_lists' ));
     Route::any('/delete-multiple-files',        array('as' => 'admin_delete_multiple_files',   'uses'=>'CustomerFileUploadController@delete_multiple_files' ));
     Route::any('/file-delete',                  array('as' => 'admin_file_delete_individual',  'uses'=>'CustomerFileUploadController@file_delete' ));
     Route::any('/zip_file_create',              array('as' => 'admin_customer_zip_file',       'uses'=>'CustomerFileUploadController@zip_file_create' ));
     ...
     Route::any('/delete-multiple-plans',                          array('as' => 'admin_delete_multiple_plans', 'uses'=>'ProjectController@delete_multiple_plans' ));
    ...
    Route::any('/delete-multiple-spec',             array('as' => 'admin_delete_multiple_specs',     'uses'=>'ProjectController@delete_multiple_specs' ));
    ...
    Route::any('/permit-exist',                        array('as' => 'permit_exist',               'uses'=>'BuildingreportController@permit_exist' ));
     ...
     Route::any('/order/invoice/{id}',                   array('as' => 'admin_order_invoice',           'uses'=>'OrderController@invoice_pdf' ));
     Route::any('/download-zip/{id}/{project_id}',       array('as' => 'admin_download_zip',            'uses'=>'OrderController@admin_download_zip' ));
